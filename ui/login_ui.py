...
def login_page(current_theme, page:ft.Page, BASE_URL:str):
        ...
        return ft.View(
            controls=[
                ...
                code_input,
                ft.ElevatedButton("Login with code", on_click=lambda _: login(page, code_input.value, BASE_URL), bgcolor=current_theme["bottom_sheet"]["button_color"], color=current_theme["bottom_sheet"]["button_text_color"]),
            ],
            appbar=appbar,
